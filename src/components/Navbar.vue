        ...
        <div class="fixed top-0 left-0 w-full bg-hgreen flex flex-col items-center min-h-[86px] font-thin justify-center shadow-md shadow-white z-[48]">
            <div class="flex justify-between items-center lg:max-w-[1200px] w-full py-2">
                <router-link to="/">
                    ...
                    <img src="../pages/images/Logotipo-Humadeus-pie.png" class="w-[120px] lg:mx-0 mx-2 lg:hidden">
                </router-link>
                    ...
                    <div class="lg:flex justify-between relative items-center lg:space-x-24">
                        ...
                        <div class="relative flex justify-between custom-ring" @mouseover="openDropdown" @mouseleave="startCloseTimer">
                            ...
                            <div v-if="isOpen" class="absolute top-10 lg:w-52 w-[44] italic rounded-none text-black border-hcream shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="options-menu" @mouseover="cancelCloseTimer" @mouseleave="closeDropdown">
                                <router-link to="/soluciones/creditos-escolarizados" class="dropdown-item block  border border-x-hcream border-t-hcream border-b-transparent font-normal px-4 text-left py-2 lg:text-sm text-[12px] text-black hover:text-hcream hover:bg-hgreen/60" role="menuitem">Créditos escolarizados</router-link>
                    ...
                    <div id="menu" :class="{ 'block': isMenuOpen, 'hidden': !isMenuOpen }" class="absolute bg-white right-0 mt-2 z-50 font-montse border border-hcream w-full">
                        <ul class="flex flex-col divide-y divide-hcream text-black text-[16px]">
                            ...
                            <li>
                                ...
                                <ul @click="toggleMenu" v-if="isDropdownOpen" class="bg-white border-t border-hcream text-[15px]">
