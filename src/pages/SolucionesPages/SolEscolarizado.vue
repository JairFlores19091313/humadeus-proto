        ...
        <div class="flex flex-col w-full">
            <div class="flex lg:flex-row flex-col justify-between lg:gap-16 gap-12 max-w-[1200px] w-full lg:mx-0 mx-4 mb-16">
                ...
                <div class="p-4 border border-hgreen w-full max-w-[560px]">
                    ...
                    <ul class="list-disc pl-5 lg:text-justify hyphens-auto space-y-2">
                        ...
                        <li>Formato de Solicitud de Crédito.</li>
                        <li>Formato de Autorización para Consulta de Buró.</li>
                    </ul>
                </div>
            </div>
            <div class="flex lg:flex-row flex-col justify-between lg:gap-16 gap-12 max-w-[1200px] w-full lg:mx-0 mx-4 mb-16">
                <div class="p-4 border border-hgreen w-full max-w-[560px]">
                    ...
                    <ul class="list-disc pl-5 lg:text-justify hyphens-auto space-y-2">
                        ...
                        <li>Antigüedad laboral 1 año.</li>
                        <li>Edad de entre 25 a 60 años.</li>
            ...
            <div class="flex lg:flex-row flex-col justify-between lg:gap-16 gap-12 max-w-[1200px] w-full lg:mx-0 mx-4 mb-16">
                <div class="text-justify lg:mx-0 mx-4 py-4 w-full">
                    ...
                    <p class=" text-justify mb-4">
                        CAT promedio __% sin IVA calculado el 7 de mayo de 2025, vigente al 7 de noviembre de 2025. Informativo. Calculado con base en un crédito de $100,000 pesos a un plazo de 36 meses y tasa de interés fija del __% anual y una comisión de apertura __%.
                    </p>
                    <p class=" text-justify mb-4">
